...
You have to integrate everything in the same project you made in previous week's task. Make a PR with a video recording of the gameplay showing all the ui and audio you have incorporated. Also include the audio_manager script in the PR.
